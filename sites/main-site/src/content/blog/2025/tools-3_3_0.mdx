...
Big thanks to everyone who contributed to this big addition to the nf-core template, especially [@maxulysse](https://github.com/maxulysse), [@adamrtalbot](https://github.com/adamrtalbot), [Sateesh Peri](https://github.com/sateeshperi), [Usman Rashid](https://github.com/GallVp) and [@edmundmiller](https://github.com/edmundmiller) for initial testing and tinkering, especially with the GitHub Actions. :raised_hands:
